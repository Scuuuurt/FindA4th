...
export const profiles = [
  ...
  },
  {
    id: 9,
    type: "Group",
    name: "Metro Match Club",
    age: "3 golfers",
    course: "Pebble Ridge",
    teeTime: "Sun · 10:12 AM",
    handicap: "12 avg",
    slots: 1,
    vibe: "Competitive",
    pace: "Ready golf",
    bio: "Sunday regulars looking for one more golfer who likes a purposeful round without killing the vibe.",
    tags: ["Late morning", "Cash game okay", "Repeat group"],
    image:
      "linear-gradient(180deg, rgba(13, 41, 28, 0.14), rgba(13, 41, 28, 0.5)), url('https://images.unsplash.com/photo-1517022812141-23620dba5c23?auto=format&fit=crop&w=900&q=80')",
    fit: "Strong repeat-round potential",
    distanceMiles: 10,
    handicapValue: 12,
    homeCourse: "Pebble Ridge",
    mobilityPreference: "either",
  ...
  },
  {
    ...
    vibe: "Social",
    pace: "Steady",
    bio: "Twilight player who likes a quick nine, good company, and easy rebooking if the group clicks.",
    tags: ["Twilight", "Walk or cart", "Good chemistry"],
    image:
      "linear-gradient(180deg, rgba(13, 41, 28, 0.14), rgba(13, 41, 28, 0.52)), url('https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?auto=format&fit=crop&w=900&q=80')",
    fit: "Great after-work fit",
    distanceMiles: 17,
    handicapValue: 13.6,
    homeCourse: "Oak Run Golf Club",
    mobilityPreference: "either",
...
export const notificationsSeed = [
  ...
  {
    id: "notif-4",
    title: "Twilight opening nearby",
    body: "Oak Run Regulars posted another Friday opening that fits your handicap window.",
    timeLabel: "3h ago",
    type: "listing",
    unread: true
  },
  {
    ...
    body: "You just crossed 3 saved rounds with a 100% would-play-again streak.",
    timeLabel: "This week",
    type: "milestone",
    unread: false
  }
